...
const SIDECARS = {
  ...
  "lmstudio-k3s": {
    ...
    label: "LM Studio",
    // Audit results (2026-03-22): Tested all 21 Nemotron models.
    // Only 1.5B-7B work on LM Studio + WSL2 (15GB RAM). 14B+ fall to CPU, unusable.
    // Nano-4B: nemotron_h arch unsupported. Nano-30B MoE: exceeds 24GB VRAM.
    starterModels: [
      { model: "opencodereasoning-nemotron-7b@q4_k_m",    label: "OpenCodeReasoning Nemotron 7B (5 GB, clean output)" },
      { model: "llama-3.1-nemotron-nano-4b-v1.1@q4_k_m",  label: "Llama Nemotron Nano 4B v1.1 (3 GB, fast)" },
      { model: "nemotron-research-reasoning-qwen-1.5b@q4_k_m", label: "Research Reasoning Qwen 1.5B (1 GB, tiny)" },
    ],
